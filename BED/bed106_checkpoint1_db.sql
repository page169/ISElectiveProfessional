...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 28, 2026 at 09:23 PM
...
--
-- Database: `bed106_checkpoint1.db`
--
...
CREATE TABLE `performance` (
  ...
  `math_score` int(11) NOT NULL CHECK (`math_score` between 0 and 100),
  `reading_score` int(11) NOT NULL CHECK (`reading_score` between 0 and 100),
  `writing_score` int(11) NOT NULL CHECK (`writing_score` between 0 and 100)
...
INSERT INTO `performance` (`performance_id`, `student_id`, `math_score`, `reading_score`, `writing_score`) VALUES
(1, 1, 72, 72, 74),
(2, 2, 69, 90, 88),
(3, 3, 90, 95, 93),
(4, 4, 47, 57, 44),
...
INSERT INTO `students` (`student_id`, `gender`, `race_ethnicity`, `parental_education`, `lunch`, `test_prep`) VALUES
...
INSERT INTO `studentsperformance` (`COL 1`, `COL 2`, `COL 3`, `COL 4`, `COL 5`, `COL 6`, `COL 7`, `COL 8`) VALUES
...
--
ALTER TABLE `performance`
  ADD CONSTRAINT `performance_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`student_id`);
COMMIT;
